...
namespace Watermelon
{
    public class UIGame : UIPage
    {
        ...
        private void Awake()
        {
            roomIndicatorsPool = new PoolGeneric<UIRoomIndicator>(roomIndicatorUIPrefab, roomIndicatorUIPrefab.name, roomsHolder);
        ...
        {
            if (roomIndicatorsPool != null)
                PoolManager.DestroyPool(roomIndicatorsPool);
        }
