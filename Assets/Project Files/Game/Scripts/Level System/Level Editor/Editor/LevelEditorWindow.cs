...
namespace Watermelon.SquadShooter
{
    public class LevelEditorWindow : LevelEditorBase
    {
        ...
        private const string ENEMIES_DATABASE_PATH = "Assets/Project Files/Data/Enemies/Enemies Database.asset";
        ...
        protected override void InitializeVariables()
        {
            ...
            enemiesDatabase = AssetDatabase.LoadAssetAtPath<EnemiesDatabase>(ENEMIES_DATABASE_PATH);
        ...
        private void DisplyLevelObjectMenagementSection()
        {
            ...
            if (GUILayout.Button(CLEAR_SCENE, EditorCustomStyles.buttonRed, GUILayout.Height(EditorGUIUtility.singleLineHeight * 2)))
            {
                ClearScene();
            }
