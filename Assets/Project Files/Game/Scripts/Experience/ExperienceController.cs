...
namespace Watermelon
{
    public class ExperienceController : MonoBehaviour
    {
        ...
        public void GainExperience(int amount)
        {
            ...
            FloatingTextController.SpawnFloatingText(FLOATING_TEXT_HASH, string.Format("+{0}", amount), CharacterBehaviour.Transform.position + new Vector3(3, 6, 0), Quaternion.identity, Color.white);
